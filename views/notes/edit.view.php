        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Edit a Note Section</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Edit a Note Section description</p>
                    <form method="post" action="/note" class="flex flex-col gap-4 justify-center items-center mt-6">
                        ...
                        <div class="flex flex-col justify-center items-start">
                            ...
                            <textarea name="body" id="body" cols="30" rows="10" required><?= $note['body'] ?></textarea>
                        </div>
